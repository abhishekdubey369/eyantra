...
class swift():
	...
	def __init__(self):
		...
		self.setpoint = [2.20,2.00,17.20] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
	...
	#-----------------------------Write the PID algorithm here--------------------------------------------------------------
		...
		if (self.timechange>self.sample_time):
			if (self.last_time!=0):			
				...
				self.cmd.rcRoll=int(1495-(self.Kp[0]*self.error[0])-(self.Kd[0]*self.derr[0]))
